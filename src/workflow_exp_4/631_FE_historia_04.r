...
PARAM$RandomForest$min.node.size <- 1200
PARAM$RandomForest$mtry <- 15
PARAM$RandomForest$semilla <- 289733 # cambiar por la propia semilla
...
dataset_input <- paste0("./exp_04/", PARAM$exp_input, "/dataset.csv.gz")
...
dir.create(paste0("./exp_04/", PARAM$experimento, "/"), showWarnings = FALSE)
# Establezco el Working Directory DEL EXPERIMENTO
setwd(paste0("./exp_04/", PARAM$experimento, "/"))
