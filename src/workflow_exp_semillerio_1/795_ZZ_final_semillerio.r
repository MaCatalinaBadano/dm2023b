...
PARAM$semilla_primos  <- 100109  # se utiliza para generar el vector de  PARAM$semillerio  semillas
...
arch_log  <- paste0( PARAM$home, "exp_sem_01/", PARAM$exp_input, "/BO_log.txt" )
tb_log  <- fread( arch_log )
setorder( tb_log, -ganancia )

#leo el nombre del expermento de la Training Strategy
arch_TS  <- paste0( PARAM$home, "exp_sem_01/", PARAM$exp_input, "/TrainingStrategy.txt" )
TS  <- readLines( arch_TS, warn= FALSE )

#leo el dataset donde voy a entrenar el modelo final
arch_dataset  <- paste0( PARAM$home, "exp_sem_01/", TS, "/dataset_train_final.csv.gz" )
dataset  <- fread( arch_dataset )

#leo el dataset donde voy a aplicar el modelo final
arch_future  <- paste0( PARAM$home, "exp_sem_01/", TS, "/dataset_future.csv.gz" )
