...
PARAM$lgb_semilla  <- 100109  #cambiar por su propia semilla
...
exp_log  <- function( reg, arch=NA, folder="./exp_sem_01/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset_input  <- paste0( "./exp_sem_01/", PARAM$exp_input, "/dataset_training.csv.gz" )
