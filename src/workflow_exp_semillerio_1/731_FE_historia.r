...
PARAM$CanaritosAsesinos$semilla  <- 100109   # cambiar por la propia semilla
...
dataset_input  <- paste0( "./exp_sem_01/", PARAM$exp_input, "/dataset.csv.gz" )
...
dir.create( paste0( "./exp_sem_01/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./exp_sem_01/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO
