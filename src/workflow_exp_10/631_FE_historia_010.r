...
dataset_input <- paste0("./exp_010/", PARAM$exp_input, "/dataset.csv.gz")
...
dir.create(paste0("./exp_010/", PARAM$experimento, "/"), showWarnings = FALSE)
# Establezco el Working Directory DEL EXPERIMENTO
setwd(paste0("./exp_010/", PARAM$experimento, "/"))
