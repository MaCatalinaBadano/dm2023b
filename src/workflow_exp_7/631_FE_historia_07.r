...
PARAM$RandomForest$max.depth <- 10
PARAM$RandomForest$min.node.size <- 200
PARAM$RandomForest$mtry <- 50
PARAM$RandomForest$semilla <- 100109 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 100109
...
dataset_input <- paste0("./exp_07/", PARAM$exp_input, "/dataset.csv.gz")
...
dir.create(paste0("./exp_07/", PARAM$experimento, "/"), showWarnings = FALSE)
# Establezco el Working Directory DEL EXPERIMENTO
setwd(paste0("./exp_07/", PARAM$experimento, "/"))
